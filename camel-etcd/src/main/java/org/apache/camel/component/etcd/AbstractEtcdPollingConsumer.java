...
public abstract class AbstractEtcdPollingConsumer extends ScheduledPollConsumer {
    ...
    protected AbstractEtcdPollingConsumer(AbstractEtcdEndpoint etcdEndpoint, Processor processor, EtcdConfiguration etcdConfiguration, EtcdActionNamespace etcdActionNamespace, String path) {
