...
/**
 * Represents the component that manages {@link ChronicleEndpoint}.
 *
...
public class ChronicleComponent extends UriEndpointComponent {
    ...
    public ChronicleComponent() {
        super(ChronicleEndpoint.class);
    }

    public ChronicleComponent(CamelContext context) {
        super(context, ChronicleEndpoint.class);
    }

    protected Endpoint createEndpoint(String uri, String remaining, Map<String, Object> parameters) throws Exception {
        Endpoint endpoint = new ChronicleEndpoint(uri, this);
